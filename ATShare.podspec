...
Pod::Spec.new do |s|
  s.name             = 'ATShare'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ATShare.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ablettchen@gmail.com/ATShare'
  ...
  s.source_files = 'ATShare/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ATShare' => ['ATShare/Assets/*.png']
  # }
